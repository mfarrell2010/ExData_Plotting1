...
plot(plot_consumption$dttm, plot_consumption$Global_active_power, type="l",xlab="",ylab="Global Active Power")

plot(plot_consumption$dttm, plot_consumption$Voltage, type="l",xlab="datetime",ylab="Voltage")
...
plot(plot_consumption$dttm, plot_consumption$Global_reactive_power, type="l",xlab="datetime",ylab="Global_reactive_power")
